...
class MoonshotLLM(BaseLLM):
        ...
        **kwargs
        ...
        try:
            ...
            if "choices" in data and len(data["choices"]) > 0:
                ...
                raise APIError("Invalid response format from Moonshot API")
    ...
    async def embedding(
        ...
        **kwargs
        ...
        request_data = {
            "model": kwargs.get("model", "moonshot-embedding"),
            "input": texts
        }
        ...
        try:
            ...
            if "data" in data:
                ...
                raise APIError("Invalid response format from Moonshot embedding API")
